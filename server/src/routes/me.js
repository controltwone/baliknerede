...
router.get('/me', auth_1.requireAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, User_1.default.findById(req.userId).select('name email bio avatarUrl isAdmin')];
            case 1:
                user = _a.sent();
                if (!user)
...
router.put('/me', auth_1.requireAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, bio, avatarUrl, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, bio = _a.bio, avatarUrl = _a.avatarUrl;
