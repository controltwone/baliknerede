                ...
                <DialogPanel className="w-full max-w-md rounded-2xl border bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm p-6 shadow-2xl">
                  <div className="mb-6 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        {showListModal === 'followers' ? 'Bu kullanıcıyı takip edenler' : 'Bu kullanıcının takip ettikleri'}
                      </p>
                    </div>
                    <button 
                    ...
                    {(showListModal === 'followers' ? followersList : followingList).length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
                          {showListModal === 'followers' ? 'Bu kullanıcıyı henüz kimse takip etmiyor' : 'Bu kullanıcı henüz kimseyi takip etmiyor'}
                        </p>
                      </div>
                    ) : (
